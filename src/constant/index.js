...
export const projectsData = [
    ...
    },
    {
        ...
        description: "An innovative water dispenser that can be controlled via a mobile app building using Arduino Uno R4 Wifi. It features a user-friendly interface, real-time monitoring, connectivity using Wifi",
        date: "Year 2024",
